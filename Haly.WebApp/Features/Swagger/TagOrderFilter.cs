...
// Avoid using the 'Tags' attribute to annotate your actions and controllers,
// cause we use a workaround for ordering tags (see below)
public class TagOrderFilter : IDocumentFilter
{
    public void Apply(OpenApiDocument swaggerDoc, DocumentFilterContext context)
    {
        ...
        swaggerDoc.Tags = controllerNames.OrderBy((name) => name == "Me" ? 0 : 1)
